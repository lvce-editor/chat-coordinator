...
// const chatNetworkWorkerPath = join(root, '.tmp/dist-chat-coordinator-worker/dist/chatNetworkWorkerMain.js')
...
// newContent = replaceWorkerUrl(newContent, 'chatNetworkWorkerUrl', 'chat-coordinator-worker', 'chatNetworkWorkerMain.js', chatNetworkWorkerPath)
